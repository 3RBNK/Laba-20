...
void test_median_filter_3_small_matrix() {
    ...
    matrix mat = create_matrix_from_array((int[]) {10, 20, 30,
                                                      25, 35, 45,
                                                      15, 25, 35}, n, n);
...
void test_median_filter_4_average_matrix() {
    ...
    matrix mat = create_matrix_from_array((int[]) {10, 20, 30, 40,50,
                                                      15, 24, 16, 17,56,
                                                      34, 54, 12, 56,  78,
                                                      14, 45, 34, 47,  56,
                                                     17, 15, 24, 56, 62}, n, n);
    ...
    matrix check = create_matrix_from_array((int[]) {10, 20, 30, 40, 50,
                                                   15, 24, 16, 17, 56,
                                                   34, 54, 34, 56, 78,
                                                   14, 45, 34, 47, 56,
                                                   17, 15, 24, 56, 62}, n, n);
...
void test_median_filter_5_big_matrix() {
    ...
    matrix mat = create_matrix_from_array((int[]) {   10, 20, 30, 40, 50, 60, 70,
    ...
    matrix check = create_matrix_from_array((int[]) {10, 20, 30, 40, 50, 60, 70,
                                                     15, 24, 36, 47, 56, 62, 68,
                                                     12, 18, 34, 44, 52, 66, 78,
